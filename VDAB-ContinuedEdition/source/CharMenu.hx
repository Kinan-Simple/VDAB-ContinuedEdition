...
{
    var menuItems:Array<String> = ['bf', 'bf-christmas', 'TRISTAN', 'bf-car'];
    ...
    override function create() 
    {
        ...
        txtDescription.setFormat("assets/fonts/comic-sans.ttf", 32);
        ...
        txtOptionTitle.setFormat("assets/fonts/comic.ttf", 32, FlxColor.WHITE, RIGHT);
        ...
        function charCheck()
            {
                ...
                switch (daSelected)
                {
                    case "bf":
                        ...
                        menuBG.color = 0xFF66FF33;
                    case "bf-christmas":
                        menuBG.loadGraphic('bg');
                        menuBG.color = 0xFF66FF33;
                    case "TRISTAN":
                        menuBG.loadGraphic('bg');
				        menuBG.color = 0xFFFF0000;
                    case "bf-car":
                        menuBG.loadGraphic('bg');
				        menuBG.color = 0xFF66FF33;
                    default:
