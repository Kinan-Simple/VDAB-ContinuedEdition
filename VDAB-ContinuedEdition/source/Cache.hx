...
class Cache extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('loading_screen'));
		menuBG.screenCenter();
		add(menuBG);

		shitz = new FlxText(12, 12, 0, "LOADING... THE MOD. THIS WILL BE VERY LONG.", 12);
		shitz.scrollFactor.set();
		shitz.setFormat("Comic Sans MS", 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(shitz);
